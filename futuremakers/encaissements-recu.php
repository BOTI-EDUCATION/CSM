					...
					<td style="width: 100%;border: 2px solid #000;">
						<table cellpadding="5">
							...
							<?php foreach ($encaissement->encaissementLignes() as $encaissementLigne) {
								...
								$amount =   Models\FIN\EncaissementRubriqueInscription::sumAmountOfRubriques($inscription,  $encaissementLigne->Mois, $encaissementLigne->EncaissementRubrique);
								$service_amount = Models\FIN\EncaissementRubriqueInscription::defaultAmountOfRubriques($inscription,  $encaissementLigne->Mois,  $encaissementLigne->EncaissementRubrique);
