...
<head>
    ...
    <meta name="description" content="Customer  Success Management | BOTI SCHOOL">
    <meta name="author" content="Boti education">
    <meta name="keywords"
        content="Boti,CSM">
         <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('/')); ?>assets/images/brand/logo-small.png" /> <!-- TITLE -->
    <title>Boti School - SCM</title> <!-- BOOTSTRAP CSS -->
    <link id="style" href="<?php echo e(asset('/')); ?>assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" /> <!-- STYLE CSS -->
    ...
    <!--- FONT-ICONS CSS -->
    <link href="<?php echo e(asset('/')); ?>assets/css/icons.css" rel="stylesheet" /> <!-- COLOR SKIN CSS -->
...
<body class="app sidebar-mini ltr light-mode">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDxAGddVbry3KcPgC3_oLCBjJ0GOKBco30"></script>
...
</html><?php /**PATH C:\xampp\htdocs\csm\src\resources\views/app.blade.php ENDPATH**/ ?>