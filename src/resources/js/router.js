...
import Depenses from "./views/paramettrage/schools/Depenses.vue";
import DepensesLead from "./views/leads/Depenses.vue";
...
// ! ------------ NEW VERSION OF TRACKING
import Indicators from "./views/tracking/Indicators.vue";
import Evaluations from "./views/tracking/Evaluations.vue";

// ! ------------ ABOUT TYPES,TEAMS AND RELEASE
...
import KanBanList from "./views/leads/kanBan.vue";
...
import Listcategory from "./views/schoollife/Listcategory.vue";
...
// !  ------------ ACTIONS LOG
import ActionExport from "./views/export_excel/Action.vue";

// ! ------------- MANAGER ACTION
import CsComponent from "./views/actions/CsCom.vue";
import SalesComponent from "./views/actions/SalesCom.vue";
...
const routes = [
    ...
    {
        path: "/listeNews/newsDetailSchoolLife/:id",
        name: "newsDetailSchoolLife",
        component: NewsDetails,
    },
    {
        path: "/listeBlogs/quoteDetailSchoolLife/:id",
        name: "quoteDetailSchoolLife",
...

    {
        ...
        name: "DeletedSchools",
        component: DeletedSchool,
    },
    {
        path: "/disabled/schools",
        name: "DisabledSchools",
        component: DisabledSchool,
    },
    {
        path: "/Depenses/schools",
        component: Depenses,
    },
    ...
    // ! ------------ LEADS ROUTES
    {
        ...
        children: [
            ...
            { path: "kanban", component: KanBanList },
        ],
    },
    {
        path: "/Depenses/lead",
        component: DepensesLead,
    },
    {
        path: "/tracking",
        name: "Tracking",
    ...
    {
        path: "/paramettrage/configs",
        name: "Configs",
        component: Config,
        children: [{ path: "", component: ConfigList }],
    },
    {
        path: "/paramettrage/section",
        name: "Section",
        component: Section,
        children: [
    ...
    { path: "/actions/sales", component: SalesComponent },

    { path: "/cs/actions", component: CsComponent },
    {
        path: "/nature",
        component: Nature,
    },
    ...
    { path: "/actions/export", component: ActionExport },
