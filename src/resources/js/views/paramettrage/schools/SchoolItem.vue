                ...
                <div class="row">
                  <div class="panel profile-cover">
                    ...
                    <div class="profile-cover__img">
                      ...
                      <div class="profile-img-content text-dark text-start w-100">
                        <div class="text-dark row w-100">
                          ...
                          <h5 class="text-muted">{{ school.presentation }}</h5>
                          </div>
                          <div class="col-12 col-md-3 text-right">
                            <div
                              v-if="school.links"
                              class="
                                social social-profile-buttons
                              "
                            >
                              <div class="">
                                <a target="_blank"
                            ...
                            <div class="app_versions text-center mt-3">
                              <ul style="    justify-content: flex-end;" class="unstyled-list d-flex">
                                ...
                                <li v-if="school.version_ios" class="me-3">
                                  ...
                                  <span class="mt-2">{{school.version_ios}}</span>
                                  </li>
                                <li v-if="school.web_link" class="">
                                  <a target="_blank" :href="`https://boti.education/${school.web_link}/login`">
                                    <img src="/csm/assets/images/brand/logo-small.png" alt="">
                                  </a>
                                  <!-- <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Livello_1" x="0px" y="0px" width="48px" height="48px" viewBox="0 0 814 1000" enable-background="new 0 0 814 1000" xml:space="preserve">
                                  <path d="M788.1,340.9c-5.8,4.5-108.2,62.2-108.2,190.5c0,148.4,130.3,200.9,134.2,202.2c-0.6,3.2-20.7,71.9-68.7,141.9  c-42.8,61.6-87.5,123.1-155.5,123.1s-85.5-39.5-164-39.5c-76.5,0-103.7,40.8-165.9,40.8s-105.6-57-155.5-127  C46.7,790.7,0,663,0,541.8c0-194.4,126.4-297.5,250.8-297.5c66.1,0,121.2,43.4,162.7,43.4c39.5,0,101.1-46,176.3-46  C618.3,241.7,720.7,244.3,788.1,340.9z M554.1,159.4c31.1-36.9,53.1-88.1,53.1-139.3c0-7.1-0.6-14.3-1.9-20.1  c-50.6,1.9-110.8,33.7-147.1,75.8c-28.5,32.4-55.1,83.6-55.1,135.5c0,7.8,1.3,15.6,1.9,18.1c3.2,0.6,8.4,1.3,13.6,1.3  C464,230.7,521.1,200.3,554.1,159.4z"/>
                                  </svg>
          ...
          <div class="card">
            ...
            <div class="card-body d-grid">
              ...
              <div class="main-profile-contact-list d-flex">
                <div v-if="school.effectif_creche&&school.effectif_creche!='null'" class="">
                ...
                <div v-if="school.effectif_maternelle&&school.effectif_maternelle!='null'" class="mt-5 mt-md-0">
                  <div class="media d-flex mb-4">
                    <div class="media-icon bg-secondary bradius me-3 mt-1">
                      <i class="fe fe-edit fs-20 text-white"></i>
                    </div>
                ...
                <div v-if="school.effectif_primaire&&school.effectif_primaire!='null'" class="mt-5 mt-md-0">
                ...
                <div v-if="school.effectif_college&&school.effectif_college!='null'" class="mt-5 mt-md-0">
                  <div class="media">
                    <div
                ...
                <div  v-if="school.effectif_lycee&&school.effectif_lycee!='null'" class="mt-5 mt-md-0">
                  <div class="media">
                    <div
                ...
                <div  v-if="school.effectif_sup&&school.effectif_sup!='null'" class="mt-5 mt-md-0">
                  <div class="media">
                    <div
                      class="media-icon bg-info text-white bradius me-3 mt-1"
                    >
    ...
    deleteChecklist: async function (e, checklist) {
      ...
      if (token) {
        ...
        this.$swal({
          ...
          if (result.isDenied) {
            await axios
              .post("/api/deleteChecklistSchool" , {
