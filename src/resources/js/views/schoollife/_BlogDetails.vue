            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h2 class="mb-0 w-100">
                            <input v-model="article.label"  type="text" id="example-email" name="label" class="form-control" style="font-size: 25px; font-weight: bold;" placeholder="Titre" required> 
                        </h2>
                    </div>
                    <div class="card-body">
                        <div class="row my-3">
                            <label for="" class="col-12 my-1 inputLabel">introduction</label>
                            <input type="text" v-model="article.introduction" class="form-control col-12" name="introduction" placeholder="text">
                        </div>
                        <div class="row my-3">
                            <label for="" class="col-12 my-1 inputLabel">category</label>
                            <vue-select class="p-0" name="value" v-model="article.category" :reduce="info => info.id" :options="categories"  label="label" placeholder="Choose item" searchable />
                        </div>
                        <div class="row my-3" v-if="hasDateMethod(article.category)">
                            <div class="row mb-4"> 
                              ...
                              <b-form-input class="col-12 col-md-4 mb-1" id="type" type="date" v-model="article.date_event" ></b-form-input>
                              <b-form-input class="col-12 col-md-4 mb-1" id="type" type="time" v-model="article.time_event" @change="setTime($event)"></b-form-input>
                            </div>
                        </div>
                        <div class="row my-3">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <div class="mt-5" >
                                    ...
                                    <label class="upload-file" for="upload" >
                                        <span aria-hidden="true" style="text-align: center;">
                                            ...
                                            <input type="file" id="upload" @change="uploadFile($event)" :v-model="uploadedImage" style="display: none;">
                                        </span>
                                ...
                                <div class="my-5 videoparent" v-if="hasVideoMethod(article.category)">
                                    ...
                                    <div>
                                        <label class="labelVideo" for="upload">change Video</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-8" >
                                <vue-editor required v-model="article.details" type="text" class="form-control" name="details" value="details"></vue-editor>
                            </div>
                            <div class="row">
                                <div class="col-9"> 
                                    <b-form-checkbox
                                ...
                                <div class="col-3 d-flex flex-row-reverse">
                                    <button class="btn btn-primary" @click.prevent="saveArticle()">Save Article</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        async saveArticle() {
            ...
            try {
                let save = await axios.post(`api/updateArticle/${this.id}`, formData)
