                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <h4> Image : </h4>
                                <img :src="article.image" alt="" class="img-fluids">
                            </div>
                            <div class="col-12 col-md-8" v-html="article.details"></div>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        getArticle: async function (postId) {
            ...
            // if (postId && token) {
                await axios
                    .get("/api/getArticleDetails/" + postId)
                    .then(async (result) => {
